...
public class Graph_cycle {
    ...
    // Main method with hardcoded testcases
    public static void main(String[] args) {
        ...
        System.out.println("Testcase 1 (Should be Yes): " + cycleDetection3(edges1, n1, m1));
        ...
        int m2 = 2;
        int[][] edges2 = { {1,2}, {2,3} };
        System.out.println("Testcase 2 (Should be No): " + cycleDetection3(edges2, n2, m2));
        ...
        System.out.println("Testcase 3 (Should be Yes): " + cycleDetection3(edges3, n3, m3));
        ...
        int m4 = 2;
        int[][] edges4 = { {1,2}, {3,4} };
        System.out.println("Testcase 4 (Should be No): " + cycleDetection3(edges4, n4, m4));
    }
    ...
    private static boolean bfs(int node, List<List<Integer>> adj, boolean[] visited){
        ...
        while(!q.isEmpty()){
            ...
            for(int neigh : adj.get(curNode)){
                ...
                else if(neigh!=parentNode) return true;
            }
        }
        return false;
    }
